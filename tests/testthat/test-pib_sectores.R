...
pib_gasto_nominal_homogenea <- get_pib_sectores(
...
pib_gasto_nominal_2007 <- get_pib_sectores(modalidad = "nominal")
...
pib_gasto_nominal_2007_acumulado <- get_pib_sectores( # nolint
