...
This function returns the Foreign direct investment to the This function
returns the Foreign direct investment to the Dominican Republic based on
the specified frequency.

## Usage

``` r
get_ied(modalidad = "pais_origen", frecuencia = "trimestral")
```
...
- modalidad:
  ...
  A character string. Options are "pais_origen" or "sector_destino".

- frecuencia:

  A character string that specifies the frequency of the exchange rates
  to be downloaded. Valid options are "trimestral", or "anual".
