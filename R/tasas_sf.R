...
.bcrd_historical_metadata <- list(
  pasiva = list(
    ...
    endpoints  = c("tbm_pasiva-1991-2007.xls", "tbm_pasivad-2008-2012.xls", "tbm_pasivad-2013-2016.xlsx", "tbm_pasivad.xlsx"),
    read_params = list(
  ...
  activa = list(
    ...
    exts       = c(".xls", ".xls", ".xlsx", ".xlsx"),
    start_dates = c("2000/01/01", "2008/01/01", "2013/01/01", "2017/01/01"),
    endpoints  = c("tbm_activa-1991-2007.xls", "tbm_activad-2008-2012.xls", "tbm_activad-2013-2016.xlsx", "tbm_activad.xlsx"),
    read_params = list(
...
#' @param filtro_tipo_tasa `<character>` Filter by rate type: `"Activa"` or `"Pasiva"`.
#' @param filtro_moneda `<character>` Filter by currency: `"DOP"` or `"USD"`.
#' @param filtro_condicion `<character>` Filter by rate condition: `"General"` or `"Preferencial"`.
#' @param filtro_grupo `<character>` Filter by grouping: `"Plazo"`, `"Promedio"`, or `"Sector"`.
#' @param filtro_detalle `<character>` Filter by detail category.
#'
#' @return A `tibble` with tidy columns.
#' @export
